...
from parzen_dynamic.GraphicBuilder import GraphicBuilder
...
if __name__ == "__main__":
    ...
    k_slider = Slider(k_axes, 'k', graphic_builder.MIN_K, graphic_builder.MAX_K, valinit=graphic_builder.k,
    ...
    current_miss = ValueBuilder.classify_miss_by_k(graphic_builder.classified_dots, ValueBuilder.euclidian_distance,
                                                   ValueBuilder.linear_kernel, graphic_builder.k)
    ...
    def calculate_hit(event):
        current_miss = ValueBuilder.classify_miss_by_k(graphic_builder.classified_dots,
                                                       ...
                                                       graphic_builder.KERNEL, graphic_builder.k)
    ...
    def update_k(val):
        ...
        update_spans_classify()
        graphic_builder.h = graphic_builder.distances[val-1][2]
