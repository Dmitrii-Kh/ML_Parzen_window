...
class ValueBuilder:
    ...
    @staticmethod
    def classify_by_parzen_dynamic(neighbours, kernel, h):
        result = dict()
    ...
    @staticmethod
    def classify_miss_by_k(learning_dots, distance_method, kernel, k):
        result = 0
        for index, learning_dot in enumerate(learning_dots):
            ...
            test_class = ValueBuilder.classify_by_parzen_dynamic(distances, kernel, distances[k][2])
